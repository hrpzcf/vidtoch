...
### 用法 2：使用 vidtoch.vTools 类[vidtoch版本0.4.0或以上]生成有声音的字符视频，依赖[FFMPEG][1]

------

#### 点击 [ffmpeg][2] 下载，解压，将bin目录中的ffmpeg.exe放到当前工作目录，或放到任意目录并将bin文件夹路径添加到环境变量，或放到任意目录，在 vTools 类中指定路径，如 vt = vTools(ffmpeg=r"d:\ffmpeg\bin\ffmpeg.exe")
